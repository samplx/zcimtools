/* nomarch 1.5 - extract old `.arc' archives.
...
struct archived_file_header_tag
  ...
  int has_crc;
  char orig_name[13];         /* name without conversion/strip */
  };
...
hdrp->name[12]=0;
memcpy((void *)hdrp->orig_name, (void *)hdrp->name, sizeof(hdrp->orig_name));
...
{
printf("nomarch %s - copyright (c) 2001-2023 Russell Marks.\n",NOMARCH_VER);
printf("\n"
